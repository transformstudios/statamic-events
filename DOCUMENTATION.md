...
If you'd like to have a different event timezone default than the app default (usually UTC), then update it via the CP. This is used on individual events that do not have a timezone set (see Fieldset below).
